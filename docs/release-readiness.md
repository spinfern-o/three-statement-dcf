...
Generated at: `2026-09-18T07:52:59+00:00`
...
| 156 | Unit tests | **PASS** | 595 passed in 0.54s | 0.9 |
| 157 | Property-based tests | **PASS** | 10 passed in 0.22s | 0.5 |
| 158 | Golden extraction tests | **PASS** | 46 passed in 13.67s | 14.0 |
| 159 | Integration tests | **PASS** | 685 passed, 2 warnings in 144.17s (0:02:24) | 144.6 |
| 160 | End-to-end tests | **PASS** | 24 passed, 2 warnings in 4.87s | 5.3 |
| 161 | Accessibility tests | **PASS** | 15 passed, 76 deselected in 7.16s | 7.6 |
| 162 | Visual regression tests | **PASS** | 72 passed, 19 deselected in 17.16s | 17.6 |
| 163 | Production build | **PASS** | 33 routes, health 200, static and tokens served | 0.9 |
| 164 | Independent arithmetic benchmark | **PASS** | 12 passed, 24 deselected in 1.02s | 1.3 |
...
| 167 | README's test count matches the suite | **PASS** | README says 1448, pytest collects 1448 | 0.0 |
