...
Generated at: `2026-09-18T06:14:46+00:00`
...
| 156 | Unit tests | **PASS** | 541 passed in 0.72s | 1.0 |
| 157 | Property-based tests | **PASS** | 10 passed in 0.21s | 0.5 |
| 158 | Golden extraction tests | **PASS** | 46 passed in 14.64s | 14.9 |
| 159 | Integration tests | **PASS** | 671 passed, 2 warnings in 139.29s (0:02:19) | 139.7 |
| 160 | End-to-end tests | **PASS** | 24 passed, 2 warnings in 4.85s | 5.3 |
| 161 | Accessibility tests | **PASS** | 15 passed, 76 deselected in 7.22s | 7.7 |
| 162 | Visual regression tests | **PASS** | 72 passed, 19 deselected in 16.30s | 16.7 |
| 163 | Production build | **PASS** | 33 routes, health 200, static and tokens served | 0.9 |
| 164 | Independent arithmetic benchmark | **PASS** | 12 passed, 24 deselected in 0.97s | 1.3 |
...
| 166 | No source PDF or secret in Git | **PASS** | No source PDF and no secret value in the tree (258 tracked file(s) checked). 20.4 holds. | 0.1 |
...
| 167 | README's test count matches the suite | **PASS** | README says 1380, pytest collects 1380 | 0.0 |
