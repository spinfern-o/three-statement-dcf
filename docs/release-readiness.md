...
Generated at: `2026-09-18T07:37:03+00:00`
...
| 156 | Unit tests | **PASS** | 595 passed in 0.61s | 0.9 |
| 157 | Property-based tests | **PASS** | 10 passed in 0.20s | 0.4 |
| 158 | Golden extraction tests | **PASS** | 46 passed in 14.43s | 14.7 |
| 159 | Integration tests | **PASS** | 680 passed, 2 warnings in 143.07s (0:02:23) | 143.6 |
| 160 | End-to-end tests | **PASS** | 24 passed, 2 warnings in 5.11s | 5.5 |
| 161 | Accessibility tests | **PASS** | 15 passed, 76 deselected in 7.38s | 7.8 |
| 162 | Visual regression tests | **PASS** | 72 passed, 19 deselected in 17.19s | 17.6 |
...
| 167 | README's test count matches the suite | **PASS** | README says 1443, pytest collects 1443 | 0.0 |
