...
Generated at: `2026-09-18T08:01:41+00:00`
...
| 156 | Unit tests | **PASS** | 595 passed in 0.53s | 0.9 |
| 157 | Property-based tests | **PASS** | 10 passed in 0.20s | 0.5 |
| 158 | Golden extraction tests | **PASS** | 46 passed in 13.98s | 14.2 |
| 159 | Integration tests | **PASS** | 686 passed, 2 warnings in 141.61s (0:02:21) | 142.1 |
| 160 | End-to-end tests | **PASS** | 24 passed, 2 warnings in 4.97s | 5.4 |
| 161 | Accessibility tests | **PASS** | 15 passed, 76 deselected in 7.08s | 7.5 |
| 162 | Visual regression tests | **PASS** | 72 passed, 19 deselected in 16.86s | 17.3 |
| 163 | Production build | **PASS** | 33 routes, health 200, static and tokens served | 0.7 |
| 164 | Independent arithmetic benchmark | **PASS** | 12 passed, 24 deselected in 0.88s | 1.2 |
...
| 167 | README's test count matches the suite | **PASS** | README says 1449, pytest collects 1449 | 0.0 |
