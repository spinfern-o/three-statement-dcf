...
Generated at: `2026-09-18T07:17:26+00:00`
...
| 156 | Unit tests | **PASS** | 589 passed in 0.53s | 0.8 |
| 157 | Property-based tests | **PASS** | 10 passed in 0.20s | 0.4 |
| 158 | Golden extraction tests | **PASS** | 46 passed in 13.90s | 14.2 |
| 159 | Integration tests | **PASS** | 678 passed, 2 warnings in 140.19s (0:02:20) | 140.7 |
| 160 | End-to-end tests | **PASS** | 24 passed, 2 warnings in 4.92s | 5.3 |
| 161 | Accessibility tests | **PASS** | 15 passed, 76 deselected in 7.03s | 7.4 |
| 162 | Visual regression tests | **PASS** | 72 passed, 19 deselected in 18.18s | 18.8 |
| 163 | Production build | **PASS** | 33 routes, health 200, static and tokens served | 0.8 |
| 164 | Independent arithmetic benchmark | **PASS** | 12 passed, 24 deselected in 1.06s | 1.4 |
| 165 | Section 4 accuracy contract | **PASS** | 20 of 22 outputs 4.16 names are compared against an implementation sharing no helper with the engine (4.15), on the dataset named below, and every comparison asserts EXACT equality rather than a toler | 1.4 |
...
| 167 | README's test count matches the suite | **PASS** | README says 1435, pytest collects 1435 | 0.0 |
