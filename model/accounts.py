...
INCOME_ACCOUNTS = (
    ...
    INTEREST_EXPENSE, OTHER_INCOME_EXPENSE, PRETAX_INCOME, TAXES, NET_INCOME,
)
...
ASSET_ACCOUNTS = (
    ...
    PPE_NET, OTHER_NONCURRENT_ASSETS,
)
LIABILITY_ACCOUNTS = (
    ACCOUNTS_PAYABLE, OTHER_CURRENT_LIABILITIES, DEBT, OTHER_NONCURRENT_LIABILITIES,
)
...
OPERATING_ITEMS = (
    NET_INCOME, DEPRECIATION_AMORTIZATION, STOCK_BASED_COMP,
    CHANGE_IN_NWC, OTHER_OPERATING,
)
INVESTING_ITEMS = (CAPEX, ACQUISITIONS, OTHER_INVESTING)
FINANCING_ITEMS = (
    DEBT_ISSUANCE, DEBT_REPAYMENT, SHARE_REPURCHASES, DIVIDENDS, OTHER_FINANCING,
)
